...
- September 19, 2026 — [Observing Container Execution and File Opens with bpftrace](bpftrace-container-exec-open-events.md) — the programs used for measurement, tracepoints and cgroup attribution, short-lived execution capture, observation timing, and lost records
- September 20, 2026 — [Mapping Language Packages Detected by Trivy to Runtime Files](trivy-language-packages-runtime-mapping.md) — package detection and file mapping for Python, Node.js, Java, and Go, measured results by method, observation timing, and evidence granularity
